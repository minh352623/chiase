          ...
          t.exports = function (e, t) {
            ...
            Object.defineProperty(f.prototype, "localDescription", {
                      ...
                      if (!(n.usingBundle && r > 0)) {
                        ...
                        (d[o.candidate.sdpMLineIndex] += s
                          ...
                          (n._localDescription.sdp =
                            p.getDescription(n._localDescription.sdp) +
                            d.join(""));
              ...
              (f.prototype.setLocalDescription = function (e) {
                ...
                if (
                  !s("setLocalDescription", e.type, t.signalingState) ||
                  t._isClosed
                )
                  return Promise.reject(
                    d(
                ...
                if ("offer" === e.type)
                  ...
                  (r = p.splitSections(t._remoteDescription.sdp)),
                    (n = r.shift());
                  ...
                  r.forEach(function (e, r) {
                    ...
                    if (
                      !(
                        (p.isRejected(e) &&
                          0 === p.matchPrefix(e, "a=bundle-only").length) ||
                        o.rejected
                      )
                    ) {
              ...
              (f.prototype.setRemoteDescription = function (n) {
                ...
                if (-1 === ["offer", "answer"].indexOf(n.type))
                  return Promise.reject(
                    d("TypeError", 'Unsupported type "' + n.type + '"')
                  );
                if (
                  !s("setRemoteDescription", n.type, i.signalingState) ||
                  i._isClosed
                )
                  return Promise.reject(
                    d(
                ...
                return (
                  ...
                  f.forEach(function (s, d) {
                    var u = p.splitLines(s),
                      ...
                      g =
                        p.isRejected(s) &&
                        0 === p.matchPrefix(s, "a=bundle-only").length,
                    ...
                    if (
                      (("offer" === n.type || "answer" === n.type) &&
                        ...
                        (i.transceivers[d].iceGatherer =
                          i.transceivers[0].iceGatherer),
                        (i.transceivers[d].iceTransport =
                          i.transceivers[0].iceTransport),
                        (i.transceivers[d].dtlsTransport =
                          i.transceivers[0].dtlsTransport),
                        i.transceivers[d].rtpSender &&
                          i.transceivers[d].rtpSender.setTransport(
                            i.transceivers[0].dtlsTransport
                          ),
                      ...
                      (_ = i.transceivers[d] || i._createTransceiver(f)),
                        (_.mid = T),
                        _.iceGatherer ||
                          (_.iceGatherer = i._createIceGatherer(d, m)),
                        N.length &&
                      ...
                      if ("sendrecv" === C || "sendonly" === C) {
                        if (
                          ...
                          (b =
                            _.rtpReceiver ||
                            new e.RTCRtpReceiver(_.dtlsTransport, f)),
                          j)
                        ) {
                          var U;
                          (I = b.track),
                            (y && "-" === y.stream) ||
                              (y
                                ? (o[y.stream] ||
                                  ...
                                  (U = o[y.stream]))
                                : (o.default ||
                                    (o.default = new e.MediaStream()),
                                  (U = o.default))),
                            U &&
                              (r(I, U), _.associatedRemoteMediaStreams.push(U)),
                            a.push([I, b, U]);
                        }
                      } else
                        _.rtpReceiver &&
              ...
              (f.prototype.createOffer = function () {
                ...
                var s = p.writeSessionBoilerplate(
                  r._sdpSessionId,
                ...
                r.transceivers.forEach(function (n, i) {
                  ...
                  o &&
                    ...
                    n.wantReceive &&
                      (n.rtpReceiver = new e.RTCRtpReceiver(
                        n.dtlsTransport,
                        a
                      )),
              ...
              (f.prototype.createAnswer = function () {
                ...
                var n = p.writeSessionBoilerplate(
                  r._sdpSessionId,
                  r._sdpSessionVersion++
                );
                r.usingBundle &&
                  ...
                  : new Promise(function (n, i) {
                      ...
                      if (e && "" !== e.candidate) {
                        ...
                        0 === u.indexOf("a=") && (u = u.substr(2)),
                          ...
                          (t[o] +=
                            "a=" + (l.type ? u : "end-of-candidates") + "\r\n"),
                          (r._remoteDescription.sdp =
                            p.getDescription(r._remoteDescription.sdp) +
                            t.join(""));
                      } else for (var f = 0; f < r.transceivers.length && (r.transceivers[f].rejected || (r.transceivers[f].iceTransport.addRemoteCandidate({}), (t = p.getMediaSections(r._remoteDescription.sdp)), (t[f] += "a=end-of-candidates\r\n"), (r._remoteDescription.sdp = p.getDescription(r._remoteDescription.sdp) + t.join("")), !r.usingBundle)); f++);
                      n();
                    });
              }),
            ...
            switch (c.browser) {
              case "chrome":
                if (!d || !d.shimPeerConnection || !o.shimChrome)
                  return (
                    s("Chrome shim is not included in this adapter release."), v
                  );
              ...
              case "safari":
                if (!u || !o.shimSafari)
                  return (
                    s("Safari shim is not included in this adapter release."), v
                  );
          ...
          t.exports = {
            ...
            shimPeerConnection: function (e) {
              ...
              (e.RTCPeerConnection = function (e) {
                return (
                  e && e.iceServers && (e.iceServers = i(e.iceServers)),
                  new a(e)
                );
              }),
              ...
              if ("object" == typeof e && e.RTCPeerConnection) {
                if (
                  ...
                  "getStreamById" in e.RTCPeerConnection.prototype ||
                    (e.RTCPeerConnection.prototype.getStreamById = function (
                      e
                    ) {
                      var t = null;
                      return (
          ...
          t.exports = {
            ...
            detectBrowser: function (e) {
              ...
              if (t.mozGetUserMedia)
                (r.browser = "firefox"),
                  (r.version = n(t.userAgent, /Firefox\/(\d+)\./, 1));
              else if (t.webkitGetUserMedia)
                (r.browser = "chrome"),
                  (r.version = n(t.userAgent, /Chrom(e|ium)\/(\d+)\./, 2));
              else if (
                t.mediaDevices &&
                t.userAgent.match(/Edge\/(\d+).(\d+)$/)
              )
                (r.browser = "edge"),
                  (r.version = n(t.userAgent, /Edge\/(\d+).(\d+)$/, 2));
              else {
                if (
                  !e.RTCPeerConnection ||
                ...
                (r.browser = "safari"),
                  (r.version = n(t.userAgent, /AppleWebKit\/(\d+)\./, 1));
              }
              return r;
            },
          };
...
(StringeeUtil.allClientsOfThisBrowser = []),
  ...
  (StringeeClient.prototype._packetReceived = function (e, t) {
    ...
    e === StringeeServiceType.CALL_SDP_CANDIDATE_FROM_SERVER
      ...
      n &&
        console.log(
          "===Packet received: service=" + e + "; body=" + JSON.stringify(t)
        );
  }),
  ...
  (StringeeClient.prototype._msgFromOtherDevice = function (e) {
    ...
    if ("CALL_STATE" === e.type) {
      ...
      var r = this.findCallByCallId(t.callId);
      r &&
        ((r.ended = !0), r._callOnEvent("otherdevice", { type: "CALL_END" }));
...
(StringeeCall.prototype.makeCall = function (e) {
  if (this.isIncomingCall)
    return void console.log("could not make call, this is a incoming call");
  var t = this,
    r = {
  ...
  (StringeeCall.prototype.answer = function (e) {
    ...
    if (!this.isIncomingCall)
      return void console.log(
        "Error: could not answer call, this is a outgoing call"
      );
    if (this.isAnswered)
      return void console.log("Error: call has been answered");
  ...
  (StringeeCall.prototype.ringing = function (e) {
    ...
    if (!this.isIncomingCall)
      return void console.log(
        "could not send ringing signal, this is a outgoing call"
      );
  ...
  (StringeeCall.prototype.hangup = function (e) {
    ...
    this.client._sendMessage(StringeeServiceType.CALL_STOP, r, function (r) {
      0 === r.r && (t._freeResource(), t.onRemove()),
        e && e.call(t, { r: r.r });
    });
  }),
  ...
  (StringeeCall.prototype.sendTransfer = function (e, t) {
    var r = this,
      n = {
        callId: this.callId,
        to: { number: e, type: "internal", alias: e },
      };
...
(StringeeProcessor._callSdpCandidateFromServer = function (e, t) {
  ...
  if (!r)
    return void console.log("error could not found call for: " + t.callId);
  if (r.answeredOnAnotherDevice)
  ...
  (StringeeProcessor._callStateFromServer = function (e, t) {
    ...
    o || (o = ""),
      100 === t.code
        ...
        : 200 === t.code &&
          ((n = StringeeCallState.ANSWERED),
          (i = "Answered"),
          (r._answeredDeviceId = o)),
      ...
      t.code >= 400
        ...
        : 200 === t.code &&
          (r._pc && r._onRemoteSDP(), r._checkAndAddCandidateFromQueue());
  }),
...
(StringeeCall.prototype._initPeerConnection = function (e, t, r) {
  ...
  function i(e) {
    t &&
      ((r.r = 1e3),
      (r.message = "GET_USER_MEDIA_ERROR"),
      (r.moreInfo = e),
      t.call(o, r)),
  ...
  (StringeeCall.prototype._checkAndAddCandidateFromQueue = function () {
    if (this.isAnswered && this._pc && this._setRemoteSdpOk) {
      this._answeredDeviceId ||
        (this._answeredDeviceId = this._mapListCandidates.allKeys()[0]);
  ...
  (StringeeCall.prototype._sendCallSdpCandidate = function (e, t, r) {
    ...
    this.client._sendMessage(
      StringeeServiceType.CALL_SDP_CANDIDATE,
      n,
      function (e) {}
    );
  }),
  ...
  (StringeeCall.prototype.mute = function (e) {
    ...
    t._localStream.getAudioTracks().forEach(function (r) {
      e
        ? ((r.enabled = !1), (t.muted = !0))
        : ((r.enabled = !0), (t.muted = !1));
    });
  }),
